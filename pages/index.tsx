    ...
    <div>
      ...
      <main>
        <div className="max-w-screen-lg text-centered mx-auto">
          ...
          <div>
            <h2 className="mt-4 mb-0 font-bold text-center text-2xl uppercase">API3 Token Supply</h2>
                          ...
                          <div className="bordered-inner">
                            ...
                            <div className="bordered-content">
                              <div id="api3-circulating-supply">
                                ...
                                >
                                  57,223,237
                                  <span className="desktop-only"> tokens</span>
                                </strong>
                  ...
                  <div className="dash-row">
                    ...
                    >
                      <span className="accent">
                        ...
                        increased by 1% for the next epoch until it reaches 75%
                      </span>
                    </p>
                  </div>
                </div>
