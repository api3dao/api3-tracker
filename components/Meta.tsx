...
export const Meta = (props: IMetaProps) => {
  ...
  const ogDescription = pg.ogDescription || opengraph.ogDescription || description;
  ...
  return (
    <Head>
      ...
      {ogTitle ? <meta property="og:title" content={ogTitle} key="title" /> : null}
      ...
      {ogDescription ? <meta property="og:description" content={ogDescription} key="description" /> : null}
    </Head>
